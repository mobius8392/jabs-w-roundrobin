...
public class RoundRobinMinerNodeWithoutTx extends RoundRobinMinerNode implements MinerNode {
    public RoundRobinMinerNodeWithoutTx(Simulator simulator, Network network, int nodeID, long downloadBandwidth,
