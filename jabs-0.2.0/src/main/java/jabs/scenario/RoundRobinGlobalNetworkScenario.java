...
import jabs.network.networks.roundrobin.RoundRobinGlobalProofOfWorkNetworkWithoutTx;
import jabs.network.stats.eightysixcountries.bitcoin.BitcoinProofOfWorkGlobalNetworkStats86Countries;

public class RoundRobinGlobalNetworkScenario extends AbstractScenario {
     ...
     */
    public RoundRobinGlobalNetworkScenario(String name, long seed, long stopTime,
    ...
    protected void createNetwork() {
        RoundRobinGlobalProofOfWorkNetworkWithoutTx<?> bitcoinNetwork =
                new RoundRobinGlobalProofOfWorkNetworkWithoutTx<>
    ...
    protected void insertInitialEvents() {
        ((RoundRobinGlobalProofOfWorkNetworkWithoutTx<?>) network).startAllMiningProcesses();
    }
